      ...
      case 2:
        return (
          <ul className="card-container">
            ...
            <li className="card">
              <h3> Индиви<span className="break-word">дуальность</span></h3>
              <p>
      ...
      case 3:
        return (
          <ul className="card-container">
            ...
            <li className="card">
              <h3>
                Индиви<span className="break-word">дуальность</span>
              </h3>
              <p>Все размеры и стили полностью оговариваются с заказчиком</p>
            </li>
            <li className="card card-margin">
              <h3 className="text-width">Долговечность</h3>
      ...
      case 4:
        return (
          <ul className="card-container">
            ...
            <li className="card card-margin">
              <h3 className="text-width-1">
                Опера<span className="break-word">тивность</span>
              </h3>
              <p>Мы всегда соблюдаем сроки и отправляем работы заранее</p>
            </li>
            <li className="card">
              <h3 className="text-width">Долговечность</h3>
              <p>
